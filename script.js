 ...
 * @Last Modified time: 2023-08-14 22:46:54
 */
...
function updateWeatherBackground(weatherCode) {
    console.log('Weather Code:', weatherCode); // Log the weather code
    const backgroundUrl = weatherToBackgroundMap[weatherCode];
    const containerElement = document.querySelector('.container');
    containerElement.style.backgroundImage = `url(${backgroundUrl})`;
}
